...
op2 = pygame.image.load('./images/me2.png').convert_alpha()
op3 = pygame.image.load('./images/Aerostrike.png').convert_alpha()
...
def menu():
    ...
    menuimg = pygame.image.load('./images/Aerostrike Menu.jpg').convert()
    ...
    while intro:
        ...
        for event in pygame.event.get():
            ...
            if event.type == SNOWSPAWN:
                snow = Snow()
                snow.rect.centery = random.randint(0,10)
                snow.rect.centerx = random.randint(int(screen_w/2+300),int(screen_w-5))
                menu_snow.add(snow)
...
def credit():
    ...
    creditimg = pygame.image.load('./images/Credits2.png')
    ...
    while over:
        ...
        for event in pygame.event.get():
            ...
            if event.type == EMBERSPAWN:
                ...
                ember.rect.centerx = random.randint(int(screen_w/2+300),int(screen_w-5))
